...
using namespace std;
int main() {
	//ifstream:- this represents input file stream and is used to read information from the files
	// ofstream:- it represents output file stream and is used to create files and to write informtation to files
